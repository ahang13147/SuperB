...
password = '8e397a5310016d27'  # MySQL password
...
def insert_room_availability():
    ...
    # Get today's date and calculate all dates for the next two weeks (from Monday to Sunday)
    today = datetime.today()
    start_of_week = today - timedelta(days=today.weekday())  # Monday's date this week
    dates_this_week = [start_of_week + timedelta(days=i) for i in range(14)]  # Next 14 days (2 weeks)
    ...
    try:
        ...
        # Commit transaction
        connection.commit()
        print("Room availability records for the next two weeks have been successfully inserted!")
