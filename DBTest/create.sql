...
CREATE TABLE Bookings (
    ...
    FOREIGN KEY (user_id) REFERENCES Users(user_id) ON DELETE CASCADE, -- Foreign key referencing Users table
...
CREATE TABLE Reports (
    ...
    FOREIGN KEY (admin_id) REFERENCES Users(user_id) ON DELETE CASCADE -- Foreign key referencing Users table (Admin)
);
...
CREATE TABLE RoomTrustedUsers (
    ...
    FOREIGN KEY (room_id) REFERENCES Rooms(room_id),      -- Foreign key referencing Rooms table
    FOREIGN KEY (user_id) REFERENCES Users(user_id) ON DELETE CASCADE,      -- Foreign key referencing Users table
    FOREIGN KEY (added_by) REFERENCES Users(user_id) ON DELETE CASCADE   -- Foreign key referencing Users table (Admin)
);
...
CREATE TABLE Issues (
    ...
    FOREIGN KEY (added_by) REFERENCES Users(user_id) ON DELETE CASCADE      -- Foreign key constraint for admin
);
