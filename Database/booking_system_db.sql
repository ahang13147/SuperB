...
CREATE TABLE Users (
    user_id INT  PRIMARY KEY,    -- User ID, auto-incremented
...
CREATE TABLE Rooms (
    room_id INT PRIMARY KEY,    -- Room ID, auto-incremented
...
CREATE TABLE Bookings (
    booking_id INT PRIMARY KEY,  -- Booking ID, auto-incremented
...
CREATE TABLE Approvals (
    approval_id INT  PRIMARY KEY,  -- Approval ID, auto-incremented
...
CREATE TABLE Notifications (
    notification_id INT PRIMARY KEY,  -- Notification ID, auto-incremented
    user_id INT NOT NULL,                            -- User ID (Foreign key referencing Users table)
...
CREATE TABLE Reports (
    report_id INT  PRIMARY KEY,      -- Report ID, auto-incremented
    admin_id INT NOT NULL,                          -- Admin ID (Foreign key referencing Users table)
