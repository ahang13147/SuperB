...
function renderReservation(reservation) {
    ...
    async function loadReservations() {
        ...
        try {
            const response = await fetch(`https://101.200.197.132:8000/bookings`);
    ...
    confirmCancelBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        const response = await fetch(
          `https://101.200.197.132:8000/cancel-booking/${reservation.booking_id}`, // Remove redundant symbols and insert variables
          {
            method: 'PUT',
