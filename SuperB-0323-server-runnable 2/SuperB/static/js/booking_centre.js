...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function fetchClassrooms() {
        ...
        try {
            const response = await fetch('https://101.200.197.132:8000/search-rooms', {
                method: 'POST',
    ...
    async function fetchIssuesForRooms(roomIds) {
        ...
        try {
            const promises = roomIds.map(roomId =>
                fetch(`https://101.200.197.132:8000/get-issues/${roomId}`)
                    .then(res => res.json())
            );
    ...
    async function handleBookingConfirmation() {
        ...
        try {
            const response = await fetch('https://101.200.197.132:8000/insert_booking', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
    ...
    async function handleReasonSubmit() {
        ...
        try {
            const response = await fetch('https://101.200.197.132:8000/insert_booking_with_reason', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    ...pendingBookingData,
