document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadNotifications() {
        try {
            ...
            const response = await fetch('https://101.200.197.132:8000/notifications', {
                credentials: 'include'
            });
 ...
 function renderNotifications(data, panelSelector) {
    ...
    async function handleMarkRead(e) {
        ...
        try {
            const response = await fetch('https://101.200.197.132:8000/update_notification_status', {
                method: 'POST',
                headers: {
    ...
    async function handleDelete(e) {
        const notificationId = e.target.closest('.notification-item').dataset.id;
        try {
            const response = await fetch('https://101.200.197.132:8000/delete_notification', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
