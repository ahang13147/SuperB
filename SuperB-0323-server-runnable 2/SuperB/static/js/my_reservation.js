document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadReservations() {
        ...
        try {
            const response = await fetch(`https://101.200.197.132:8000/user-bookings?user_id=${DEFAULT_USER_ID}`);
    ...
    confirmCancelBtn.addEventListener('click', async () => {
        ...
        try {
            const response = await fetch(`https://101.200.197.132:8000/cancel-booking/${reservation.booking_id}`, {
                method: 'PUT',
